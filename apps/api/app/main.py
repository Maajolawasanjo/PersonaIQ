...
from app.api import auth, compare, dashboard, export, health, journey, plans, presence_dna, share, stylist, upload, user, wardrobe
...
app.include_router(stylist.router, prefix=settings.API_V1_STR)
